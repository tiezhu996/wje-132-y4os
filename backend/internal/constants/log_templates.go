...
const (
	...
	LogRectificationTaskCreated   = "rectification task created"
	LogRectificationAssignSuccess = "rectification assign success"
	LogRectificationSubmitSuccess = "rectification submit success"
	LogRectificationReviewPass    = "rectification review pass"
	LogRectificationReviewReturn  = "rectification review return"
	LogRectificationStatusFailed  = "rectification status change failed"
