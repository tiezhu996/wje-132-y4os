...
const (
	...
	LogRectTaskRegisterSuccess    = "rectification task register success"
	LogRectTaskSubmitSuccess      = "rectification task submit success"
	LogRectTaskRejectSuccess      = "rectification task reject success"
	LogRectTaskApproveSuccess     = "rectification task approve success"
	LogRectTaskStatusChangeFailed = "rectification task status change failed"
